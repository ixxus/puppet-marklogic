...
describe 'marklogic' do
  ...
  it { should_not contain_class('marklogic::version::v6::install') }
  it { should     contain_class('marklogic::version::v6::upgrade') }
  it { should_not contain_class('marklogic::version::v7::install') }
  it { should_not contain_class('marklogic::version::v7::upgrade') }
